...
export default function GoodsCategoriesPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			const url = isEditing
				? `/api/procurement/goods/categories/${editingId}`
				: "/api/procurement/goods/categories";
	...
	const handleDelete = async (id: string) => {
		if (
			!confirm(
				"Are you sure you want to delete this category? This will affect all goods items using this category."
			)
		) {
			return;
		}
